...
add_action('login_head', 'jigsaw_custom_login_logo');
function jigsaw_custom_login_logo() {
  	echo '<style type="text/css">h1 a { background: url(/wp-content/themes/jigsaw/images/your_logo.png) 50% 50% no-repeat !important; }</style>';
}
...
add_filter( 'login_headerurl', 'jigsaw_custom_logo_url' );
function jigsaw_custom_logo_url( $url ) {
...
function jigsaw_dashboard_widget_function() {
  	echo '<h2>Welcome</h2>';
  	...
  	echo '<p><a href="http://Your-URL-Here/wp-content/themes/jigsaw/docs/Site_&_Content_Guide.pdf" target="_blank">Site &amp; Content Guide</a></p>';
} 
  
add_action('wp_dashboard_setup', 'jigsaw_add_dashboard_widgets' );
function jigsaw_add_dashboard_widgets() {
  	wp_add_dashboard_widget('jigsaw_dashboard_widget', 'Welcome & Support', 'jigsaw_dashboard_widget_function');
}
...
add_filter('admin_footer_text', 'jigsaw_remove_footer_admin');
function jigsaw_remove_footer_admin () {
