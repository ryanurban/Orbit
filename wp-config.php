 ...
 *
 * Here I will usually pick a random prefix for additional security.
 *
 */
$table_prefix  = 'wp_';
...
/**
 * Extra bits for speed & optimization 
 *
 * @link http://codex.wordpress.org/Editing_wp-config.php
 * @link http://digwp.com/2009/06/wordpress-configuration-tricks/
 */

/** Define blog address & site address */
...
/** Specify Number of Post Revisions */
define('WP_POST_REVISIONS', 3);  // 3 revisions

/** Specify when to empty trash */
define('EMPTY_TRASH_DAYS', 7 );  // 7 days

/** Specify cookie domain */
define('COOKIE_DOMAIN', '.your-url-here.com'); // don't omit the leading '.'
